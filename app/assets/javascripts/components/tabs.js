$(document).ready(function() {
  ...
  $(".presentation-btn").click(function() {
    $(".active-tab").removeClass("active-tab").fadeOut(300, function() {
      $(".presentation-tab").addClass("active-tab").fadeIn(300);
    });
  ...
  $(".menu-btn").click(function() {
    $(".active-tab").removeClass("active-tab").fadeOut(300, function() {
      $(".menu-tab").addClass("active-tab").fadeIn(300);
    });
    $(".tab-btn").prop('disabled', false);
  ...
  $(".reference-btn").click(function() {
    $(".active-tab").removeClass("active-tab").fadeOut(300, function() {
      $(".reference-tab").addClass("active-tab").fadeIn(300);
    });
    $(".tab-btn").prop('disabled', false);
